# Proyectos Final de Ciclo de 2º DAW-T
**curso 2025|26**

En este repositorio se encuentra centralizada toda la información relativa a los **Proyectos de Desarrollo de Aplicaciones WEB** (Turno de tarde) del CPIFP Alan Turing** (proyectos de fin de ciclo), en la convocatoria del curso 2025|26.

## Requisitos y criterios a seguir

Tanto los criterios generales como los criterios particulares por cada módulo se encuentran en [la Wiki de este repositorio](https://github.com/galinadim/proyectos-curso-2025-2026-2-DAW-T/wiki), así como en [la Moode del módulo del Proyecto Intermodular](https://educacionadistancia.juntadeandalucia.es/centros/malaga/course/view.php?id=5998)
## Profesores
 ...
 **01: Intellcar** -  Grupo 1: José Manuel Villanúa Pozo | Juan Benítez Muñoz
  ...
  **03: Sushi Miyu** -  Grupo 3: Ainhoa Quintero Gonzáles | Adriana Salazar Daza | Joaquín Ruiz Jiménez
    - [Repositorio del proyecto](https://github.com/Adrianasd22/Sushi)
     [Checkpoint](https://www.youtube.com/watch?v=Vj0Q-vowsS8&t=10s)
  ...
  **10: Wiki Ark** - Iván Calatayud Merino
    - [Repositorio del proyecto](https://github.com/Icame05/WikiArk)
     [Checkpoint](https://youtu.be/f5h915E3cOw?si=zGRPqN8GEDudZlnA)
...
* Exposiciones: ** 15 de junio de 2026**

#### :calendar: 15 de junio de 2026
